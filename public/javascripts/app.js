...
var createSongRow = function(songNumber, songName, songLength) {
  ...
  // Change from a play button to song number when the song isn't playing and we hover off the row.
   ...
   // Toggle the play, puase, and song number based on the button clicked.
   var clickHandler = function(event) {
    ...
    if (currentlyPlayingSong !== songNumber) {
      ...
      $(this).html('<a class="album-song-button"><i class="fa fa-play"></fa></a>');
...
blocJams.directive('slider', ['$document', function($document){
  ...
  return {
    ...
    link: function(scope, element, attributes) {
      ...
      // For now, we're supplying arbitrary inital and max values.
      scope.value = 0;
      scope.max = 100;
     var $seekBar = $(element);
